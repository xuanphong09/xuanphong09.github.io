                ...
                case 'countdown':
                    ...
                    timedAction(function (index) {
                        if (index === 0) {
                            ...
                            if(index > 10){
                                let days = Math.floor(index / (24 * 60 * 60));
                                let hours = Math.floor((index % (24 * 60 * 60)) / (60 * 60));
                                let minutes = Math.floor((index % (60 * 60)) / 60);
                                ...
                                display += seconds + 's';
                                S.Shape.switchShape(S.ShapeBuilder.letter(display.trim()), true);
                            }
                            else
                                S.Shape.switchShape(S.ShapeBuilder.letter(index), true);
                        }
                    }, isMobile ? 1200 : 1200, value, true);
                    break;
